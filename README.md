...
## Description
This lecture is part of Industry X.O course given at [Master Program](https://en.uit.no/education/program/446264/industrial_engineering_-_master) at Department of Industrial Engineering, [UiT The Arctic University of Norway](https://en.uit.no/). 
In this lecture, students will learn about basic concepts of AI and ML, including their applications. Lecture materials including codes, dataset, and slides are provided in this repository. 
...
```terminal
git clone https://github.com/wanprabu/industry-x0.git
```
